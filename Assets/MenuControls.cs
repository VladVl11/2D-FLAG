...
public partial class @MenuControls: IInputActionCollection2, IDisposable
{
    ...
    ~@MenuControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MenuControls.Player.Disable() has not been called.");
    ...
    public struct PlayerActions
    {
        ...
        /// </summary>
        public PlayerActions(@MenuControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
